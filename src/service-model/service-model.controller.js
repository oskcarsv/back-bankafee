...
export const getServicesByCategory = async (req, res) => {
    try {
        const services = await serviceModel.find({ category: req.params.id, status: true });
        const totalServices = services.length;
...
export const getServicesByCompany = async (req, res) => {
    try {
        const services = await serviceModel.find({ company: req.params.company, status: true });
        const totalServices = services.length;
