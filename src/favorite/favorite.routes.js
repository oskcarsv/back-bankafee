...
router.post(
  ...
  [
    validateJWT,
    check("noOwnerAccount", "The Number of the Owner Account is required")
      .not()
      .isEmpty(),
    check("favorites.*.noAccount", "The Number of the Account is required")
      .not()
      .isEmpty(),
    check("favorites.*.alias", "The Alias for the Account is required")
      .not()
      .isEmpty(),
